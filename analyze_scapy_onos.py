...
def process_pcap(file_name):
    ...
    for pkt_data in PcapReader(file_name):
        ...
        packet_in = re.findall(b'(010a)(.{4})(00000000ffffffff)(.{8})(0100)(.{52})(.{8})(ac100164)(.{4})(.{4})', payload)
        flow_mod = re.findall(b'(010e)(.{68})(.{8})(ac100164)(.{4})(61ab)(.{16})(000000000000000affffffffffff0001)', payload)
        ...
        if flow_mod:
            ...
            for i in range(len_flow_mod):
                IPport = ((flow_mod[i][2]) + b':' + (flow_mod[i][4])).decode() # IPaddress:port

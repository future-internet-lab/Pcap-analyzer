...
def process_pcap(file_name):
    ...
    for pkt_data in PcapReader(file_name):
        ...
        # if count == 1:
        #     first = pkt_timestamp
        # if pkt_timestamp < first + 120:
        #     continue
        # if pkt_timestamp > first + 160:
        #     break

        tcp_payload = pkt_data.lastlayer()  # Get payload of TCP layer
        payload = binascii.hexlify(bytes(tcp_payload)) # Convert to heximal
                                        #0a000002      # ac100164 // IP 172.16.1.100  0a000002      # 0913 // port 2323
        packet_in = re.findall(b'(040a)(.{4})(00000000ffffffff)(.{4})(0{20})(.{88})(.{8})(0a000002)(0800)', payload)
        flow_mod = re.findall(b'(040e)(.{12})(0{44})(0001)(ffffffff)(0{24})(.{94})(.{8})(.{8})(0a000002)(0{4})', payload)
        ...
        if flow_mod:
            ...
            for i in range(len_flow_mod):
                IPport = (flow_mod[i][7]).decode() # IPaddress:port

...
def process_pcap(file_name):
    ...
    return np.array(list_packetin_timestamp), np.array(list_flowmod_timestamp)
...
if __name__ == '__main__':
    ...
    for file_name in [file_name_1, file_name_2]:
        if not os.path.isfile(file_name):
            ...
            sys.exit(-1)
    list_packet_1_timestamp = process_pcap(file_name_1)[0]
    list_packet_2_timestamp = process_pcap(file_name_2)[1]
    plot_graph(list_packet_1_timestamp, list_packet_2_timestamp, name)

...
def process_pcap(file_name):
    ...
    for pkt_data in PcapReader(file_name):
        ...
        packet_in = re.findall(b'(010a)(.{4})(00000000ffffffff)(.{8})(0100)(.{52})(.{8})(ac100164)(0800)', payload)
        flow_mod = re.findall(b'(010e)(.{68})(.{8})(ac100164)(.{4})(.{20})(000000000000000affffffff)', payload)
